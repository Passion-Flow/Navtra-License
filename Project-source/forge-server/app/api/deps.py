"""FastAPI dependencies — DB session, current user (from server session cookie), context."""
...
def audit_ctx(request: Request) -> dict:
    """Common audit fields (ip / user-agent / request_id) for service-layer audit writes."""
    return {
